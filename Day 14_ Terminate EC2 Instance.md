...
aws ec2 terminate-instances --instance-ids $INSTANCE_ID --region us-east-1     # terminates instance

aws ec2 wait instance-terminated --region us-east-1 --instance-ids $INSTANCE_ID     #wait until instance is terminated
```
